package org.jboss.sbomer.java.generator.core.port.api;
...
public interface GenerationOrchestrator {
     ...
     * @param generatorOptions The options passed to from the generation recipe
     * @param handlerProvidedOptions The handler provided options passed for an individual generation task
     * @param traceParent  W3C traceparent header (00-<traceId>-<spanId>-<traceFlags>) captured from inbound Kafka span.
     */
    void acceptRequest(String generationId, GenerationRequestSpec request, Map<String, String> generatorOptions, Map<String, String> handlerProvidedOptions, String traceParent);
